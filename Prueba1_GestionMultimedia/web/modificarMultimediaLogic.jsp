...
<html lang="es">
    ...
    <body>
        ...
        Multimedia md = new Multimedia(multimediaId, titulo, descripcion, url, tipo);
        DbHelper dbh = new DbHelper();
        
        if (dbh.actualizarMultimedia(md)) {
        %>
        <div class="container d-flex justify-content-center">
            <div class="card shadow-lg p-4 success-card" style="max-width: 500px;">
                <div class="card-body">
                    <h4 class="card-title text-dark"><i class="fas fa-check-circle" style="color: #343a40;"></i> ¡Multimedia modificado!</h4>
        ...
        <div class="container d-flex justify-content-center">
            <div class="card shadow-lg p-4 error-card" style="max-width: 500px;">
                <div class="card-body">
                    ...
                    <p class="card-text">Ocurrió un error al modificar el multimedia. Inténtalo de nuevo...</p>
